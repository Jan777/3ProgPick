...
public class MenuCreacionPj extends JFrame {
	...
	public MenuCreacionPj(final Cliente cliente, final PaquetePersonaje personaje) {
		...
		setTitle("War Draft - Crear personaje");
		...
		destreza.setForeground(new Color(0, 100, 0));
		...
		energia.setForeground(new Color(0, 100, 0));
		...
		lblCasta.setForeground(Color.BLACK);
