		...
		try {
			...
			while (!((paquete = gson.fromJson(cadenaLeida, Paquete.class)).getComando() == Comando.DESCONECTAR)) {
				...
				case Comando.ACTUALIZARPERSONAJE:
					...
					Servidor.getPersonajesConectados().get(paquetePersonaje.getId())
							.setSaludTope(paquetePersonaje.getSaludTope());
					Servidor.getPersonajesConectados().get(paquetePersonaje.getId())
							.setEnergiaTope(paquetePersonaje.getEnergiaTope());
					Servidor.getPersonajesConectados().get(paquetePersonaje.getId())
							.setDestreza(paquetePersonaje.getDestreza());
					Servidor.getPersonajesConectados().get(paquetePersonaje.getId())
							.setFuerza(paquetePersonaje.getFuerza());
					Servidor.getPersonajesConectados().get(paquetePersonaje.getId())
							.setInteligencia(paquetePersonaje.getInteligencia());
					Servidor.getPersonajesConectados().get(paquetePersonaje.getId())
							.setNivel(paquetePersonaje.getNivel());
					Servidor.getPersonajesConectados().get(paquetePersonaje.getId())
							.setExperiencia(paquetePersonaje.getExperiencia());
